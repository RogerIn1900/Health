...
private val DarkColorScheme = darkColorScheme(
    ...
    surface = darkContentColor,
    primaryContainer = darkBackgroundColor,
    tertiary = darkBackgroundColor,
...
private val LightColorScheme = lightColorScheme(
    ...
    surface = lightContentColor,
    primaryContainer = lightBackgroundColor,
    tertiary = lightBackgroundColor,

//    primarySurface = lightBackgroundColor,
    primary = lightBackgroundColor,
    secondary = lightBackgroundColor,
    error = lightBackgroundColor,
...
private val DarkColors3 = darkColorScheme(
    ...
    tertiaryContainer = darkBackgroundColor,
    onTertiaryContainer = darkBackgroundColor,
    error = darkBackgroundColor,
    errorContainer = darkBackgroundColor,
    onError = darkBackgroundColor,
    onErrorContainer = darkBackgroundColor,
    background = darkBackgroundColor,
    onBackground = darkBackgroundColor,
    surface = darkBackgroundColor,
    onSurface = darkBackgroundColor,
    surfaceVariant = darkBackgroundColor,
    onSurfaceVariant = darkBackgroundColor,
    outline = darkBackgroundColor,
    ...
    outlineVariant = darkBackgroundColor,
    scrim = darkBackgroundColor,
)
